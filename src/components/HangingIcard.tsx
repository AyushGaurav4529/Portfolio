...
export interface HangingIcardProps {
  name?: string;
  role?: string;
  institution?: string;
  avatarUrl?: string;
...
/**
 * Hanging 3D Flipping ID Card (ICARD) Component in TypeScript
 */
export const HangingIcard: React.FC<HangingIcardProps> = ({
  name = "Ayush Gaurav",
