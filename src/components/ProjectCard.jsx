...
/**
 * Modern 3D Tilt Project Card Component with Specular Lighting Effect
 * 
 * Features:
 * - Physics-based 3D tilt tracking using Framer Motion springs.
 * - Dynamic specular lighting glow overlay following cursor movement.
 * - Glassmorphism dark aesthetic with z-axis depth separation (translateZ).
